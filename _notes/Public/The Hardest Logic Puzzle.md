...
As such, by appending the last part _"If I asked you if $P$ is true and if does da mean no, would you give the same answer?"_, then I can act as if ja means yes and da means no.
